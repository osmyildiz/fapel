                        ...
                        <div class="cell-box">
                            <ul class="isotope-filters-responsive">
                                ...
                                <li class="block-top-level">
                                    ...
                                    <div id="isotope-1" class="isotope-filters isotope-filters-horizontal" style="position: relative !important">
                                        <ul class="inline-list">
                                            <li><a data-isotope-filter="*" data-isotope-group="gallery" href="#" class="active">All</a></li>
                                            <li><a data-isotope-filter="Category 1" data-isotope-group="gallery" href="#">Food</a></li>
                                            <li><a data-isotope-filter="Category 2" data-isotope-group="gallery" href="#">Venue</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="cell-xs-12 offset-top-40">
                        ...
                        <div data-isotope-layout="fitRows" data-isotope-group="gallery" data-photo-swipe-gallery="gallery" class="row isotope">
                            @foreach($food as $key=>$foo)
                                <div data-filter="Category 1" class="col-xs-12 col-sm-6 col-md-4 isotope-item" style="position: relative; left: 0px; top: 0px;">
