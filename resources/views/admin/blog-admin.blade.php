            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" method="post" action="/add-blog" enctype="multipart/form-data">
                        ...
                        <!-- SEO İçerik (TR) -->
                        <div class="mb-4 row">
                            <label for="seo_content_tr" class="col-md-3 col-form-label">SEO İçerik (TR)</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="seo_content_tr" name="seo_content_tr"></textarea>
                                @error('seo_content_tr')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <!-- SEO İçerik (EN) -->
                        <div class="mb-4 row">
                            <label for="seo_content_en" class="col-md-3 col-form-label">SEO İçerik (EN)</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="seo_content_en" name="seo_content_en"></textarea>
                                @error('seo_content_en')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        <div class="mb-4 row">
                            <label for="seo_content_ar" class="col-md-3 col-form-label">SEO İçerik (AR)</label>
                            <div class="col-sm-9">
                                <textarea class="form-control" id="seo_content_ar" name="seo_content_ar"></textarea>
                                @error('seo_content_ar')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
