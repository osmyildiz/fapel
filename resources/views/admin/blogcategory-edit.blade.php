...
@section('title') BLOG KATEGORİ @endsection
...
@section('content')
    ...
    @component('admin.components.breadcrumb')
        ...
        @slot('title') BLOG Kategori @endslot
    @endcomponent
    ...
    <div class="card">
        <form method="POST" class="form-horizontal" action="/update-blogcategory/{{$res->id}}" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <h4 class="card-title mb-4">Blog Kategori Güncelle </h4>
                <div class="row">
